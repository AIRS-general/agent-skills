...
Use a separate endpoint for file upload.
If you have other payload, use another endpoint.
...
Can use a 2-step “create → upload” pattern to create record and upload files.

In the frontend, these can be two separate requests in one form.
